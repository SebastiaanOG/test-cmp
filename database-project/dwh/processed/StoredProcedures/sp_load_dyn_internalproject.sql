...
BEGIN
    ...
    BEGIN TRY
        ...
        IF OBJECT_ID('tempdb..#temp_dyn_internalproject') IS NOT NULL
            BEGIN
                DROP TABLE #temp_dyn_internalproject
            END
        ...
        (
            ...
            [internalprojecttypeid_value] NVARCHAR(100),
            [startdate] DATE,
        ...
        INSERT INTO #temp_dyn_internalproject
        SELECT
        ...
        INSERT INTO [processed].[dyn_internalproject]
        (
            [dwh_valid_from],
            [dwh_valid_to],
            [dwh_active],
