CREATE OR ALTER PROCEDURE [processed].[sp_load_dyn_account]
...
BEGIN
    ...
    BEGIN TRY
        ...
        (
            ...
            [country_value],
            [accountclassificationcode],
            LEFT([accountclassificationcode_value], 4000),
            [accountnumber],
            [accountratingcode],
            LEFT([accountratingcode_value], 4000),
            [address1_city],
            LEFT([address1_composite], 4000),
            [address1_country],
            [address1_line1],
            ...
            [address1_stateorprovince],
            [address2_addresstypecode],
            LEFT([address2_addresstypecode_value], 4000),
            [address2_freighttermscode],
            LEFT([address2_freighttermscode_value], 4000),
            [address2_shippingmethodcode],
            LEFT([address2_shippingmethodcode_value], 4000),
            [businesstypecode],
            LEFT([businesstypecode_value], 4000),
            [creditonhold],
            LEFT([creditonhold_value], 4000),
            [customersizecode],
            LEFT([customersizecode_value], 4000),
            LEFT([description], 4000),
            [donotbulkemail],
            LEFT([donotbulkemail_value], 4000),
            [donotbulkpostalmail],
            LEFT([donotbulkpostalmail_value], 4000),
            [donotemail],
            LEFT([donotemail_value], 4000),
            [donotfax],
            LEFT([donotfax_value], 4000),
            [donotphone],
            LEFT([donotphone_value], 4000),
            [donotpostalmail],
            LEFT([donotpostalmail_value], 4000),
            [donotsendmm],
            [emailaddress1],
            [exchangerate],
            [fax],
            [followemail],
            LEFT([followemail_value], 4000),
            [industrycode],
            LEFT([industrycode_value], 4000),
            [marketingonly],
            LEFT([marketingonly_value], 4000),
            [merged],
            LEFT([merged_value], 4000),
            [numberofemployees],
            [opendeals],
            ...
            [openrevenue_base],
            [ownershipcode],
            LEFT([ownershipcode_value], 4000),
            [parentaccountid],
            [parentaccountid_value],
            [participatesinworkflow],
            LEFT([participatesinworkflow_value], 4000),
            [preferredcontactmethodcode],
            LEFT([preferredcontactmethodcode_value], 4000),
            [primarycontactid_value],
            [revenue],
            [revenue_base],
            [shippingmethodcode],
            LEFT([shippingmethodcode_value], 4000),
            [sic],
            [telephone1],
            [territorycode],
            LEFT([territorycode_value], 4000),
            [tickersymbol],
