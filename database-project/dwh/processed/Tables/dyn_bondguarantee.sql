...
GO
exec sys.sp_addextendedproperty @name=N'Source System', @value=N'DWH', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_bondguarantee', @level2type=N'COLUMN', @level2name=N'ProcessRunId_source'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Source Schema', @value=N'staging', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_bondguarantee', @level2type=N'COLUMN', @level2name=N'ProcessRunId_source'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Source Table', @value=N'EntityBondguarantee', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_bondguarantee', @level2type=N'COLUMN', @level2name=N'ProcessRunId_source'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Source Field Name', @value=N'ProcessRunId_source', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_bondguarantee', @level2type=N'COLUMN', @level2name=N'ProcessRunId_source'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Source Datatype', @value=N'int', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_bondguarantee', @level2type=N'COLUMN', @level2name=N'ProcessRunId_source'; 
GO
