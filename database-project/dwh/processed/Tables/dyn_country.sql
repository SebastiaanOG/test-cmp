...
GO
exec sys.sp_addextendedproperty @name=N'Display Name', @value=N'dwh_proces_run_id', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_country', @level2type=N'COLUMN', @level2name=N'dwh_proces_run_id'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Description', @value=N'proces run id of the synapse pipeline', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_country', @level2type=N'COLUMN', @level2name=N'dwh_proces_run_id'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Example Values', @value=N'FFF57AF8-D10A-EA11-A811-000D3A2C5614', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_country', @level2type=N'COLUMN', @level2name=N'dwh_proces_run_id'; 
GO
...
GO
exec sys.sp_addextendedproperty @name=N'Source System', @value=N'Derived from synapse pipeline', @level0type=N'SCHEMA', @level0name=N'processed', @level1type=N'TABLE', @level1name=N'dyn_country', @level2type=N'COLUMN', @level2name=N'dwh_proces_run_id'; 
GO
